...
ok = 0
cp = 0
boys_name = ['Yamasato Akae','Shinohara Kana','Uzumaki Nao','Morita Risu','Saiki Rin','Tsuji Yukiyo','Nagata Reichiru','Mase Kita','Tatsuno Erisu','Yanagida Makiko','Inugami Naoki','Kano Denbe','Yokota Taikan','Takata Shusaku','Kagiyama Masashi','Ejiri Shunji','Kunieda Sotaro','Amagawa Soetsu','Yanagisawa Dokuohtei','Yasuda Hirokichi','Shiba Uta','Iwamoto Rin','Matsushima Maru','Ebinuma Seka','Tahara Ikoi','Hirata Kuniko','Takamitsu Tomiju','Sera Tomo','Yamaoka Tsukiko','Yoshiya Tsuna','Utada Sayuri','Koizumi Taru','Kanbayashi Amari','Futaki Taji','Nakashima Hama','Uyemura Naomi','Tashiro Hatsuyo','Fukumoto Han','Okamura Gen','Hamano Risa','Nagaoka Anda','Kashiwagi Yoko','Wakui Kawa','Kagurazaka Mitsu','Fukuyo Esumi','Wakimoto Yasu','Ueda Himeko','Muraoka Ao','Matsuda Mayumi','Tsuga Kioko','Tsukino Kazu','Okuma Seki','Sumisu Saya','Mitsui Kinuko','Adachi Yasuko','Utada Kamlyn','Okabe Erika','Kudo Runa','Sunada Mika','Hamamoto Hitomo','Toda Masako','Kanagi Honomi','Uyehara Tomomi','Kirigaya Emiya','Horiuchi Namie','Aomine Ruru','Oshiro Taru','Terada Esumi','Ishida Chiyumi','Oki Iku','Nakao Urako','Wakao Otsune','Takagi June','Mashimo Kochiyo','Hatsu Shizu','Maeno Inaho','Watanabe Yoshiko','Fujioka Mana','Yoritaka Sawako','Tamatsuki Satoko','Harigae Shige','Soga Fumiko','Matsui Ruri','Yokoyama Ano','Umeda Masako','Uyeno Tane','Sumida Ruriko','Ikari Kahori','Seta Risu','Hashi Kurumi','Nitta Yoshiko','Katagiri Otsune','Yamashina Yukako','Toyoda Tamaki','Suto Yumisa','Okimoto Toshi','Hano Sayoko','Koizumi Bachiko','Oh Yuma','Imada Rio']
girls_name = ['Yamasato Akae','Shinohara Kana','Uzumaki Nao','Morita Risu','Saiki Rin','Tsuji Yukiyo','Nagata Reichiru','Mase Kita','Tatsuno Erisu','Yanagida Makiko','Inugami Naoki','Kano Denbe','Yokota Taikan','Takata Shusaku','Kagiyama Masashi','Ejiri Shunji','Kunieda Sotaro','Amagawa Soetsu','Yanagisawa Dokuohtei','Yasuda Hirokichi','Shiba Uta','Iwamoto Rin','Matsushima Maru','Ebinuma Seka','Tahara Ikoi','Hirata Kuniko','Takamitsu Tomiju','Sera Tomo','Yamaoka Tsukiko','Yoshiya Tsuna','Utada Sayuri','Koizumi Taru','Kanbayashi Amari','Futaki Taji','Nakashima Hama','Uyemura Naomi','Tashiro Hatsuyo','Fukumoto Han','Okamura Gen','Hamano Risa','Nagaoka Anda','Kashiwagi Yoko','Wakui Kawa','Kagurazaka Mitsu','Fukuyo Esumi','Wakimoto Yasu','Ueda Himeko','Muraoka Ao','Matsuda Mayumi','Tsuga Kioko','Tsukino Kazu','Okuma Seki','Sumisu Saya','Mitsui Kinuko','Adachi Yasuko','Utada Kamlyn','Okabe Erika','Kudo Runa','Sunada Mika','Hamamoto Hitomo','Toda Masako','Kanagi Honomi','Uyehara Tomomi','Kirigaya Emiya','Horiuchi Namie','Aomine Ruru','Oshiro Taru','Terada Esumi','Ishida Chiyumi','Oki Iku','Nakao Urako','Wakao Otsune','Takagi June','Mashimo Kochiyo','Hatsu Shizu','Maeno Inaho','Watanabe Yoshiko','Fujioka Mana','Yoritaka Sawako','Tamatsuki Satoko','Harigae Shige','Soga Fumiko','Matsui Ruri','Yokoyama Ano','Umeda Masako','Uyeno Tane','Sumida Ruriko','Ikari Kahori','Seta Risu','Hashi Kurumi','Nitta Yoshiko','Katagiri Otsune','Yamashina Yukako','Toyoda Tamaki','Suto Yumisa','Okimoto Toshi','Hano Sayoko','Koizumi Bachiko','Oh Yuma','Imada Rio']
